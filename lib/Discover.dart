...
//                              return_section_name( title:'Shop by Brand',ontap: (){}),
                              return_section_name_shop_byBrand( title:'Shop by Brand'),

                              _discoverWidget(
                                images_array: snapshot.data.shop_by_brand,),
                              SizedBox(height: 5.0),
                              return_section_name( title: 'Spaced Out',ontap: (){
                                Navigator.of(context).push(
                                    MaterialPageRoute(
                              ...
                              return_listView_shopbyproduct(product: snapshot.data.shop_by_product,),
...
//                        color: const Color(0xff000000),
  ...
  Widget return_section_name_shop_byBrand({@required String title}){
    return  Padding(
      padding: const EdgeInsets.symmetric(horizontal: 30,vertical: 20),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
            ...
            itemBuilder: (BuildContext context, int index) =>
                InkWell(
                  onTap: (){
                    ...
                    Navigator.of(context).push(
                        MaterialPageRoute(
//                            builder: (BuildContext context) => Product(product_id:  product[index]['products'][0]['id'],)
                            builder: (BuildContext context) => Product(product_id:  product[index]['id'],)
                        )
                    );
                  },
                  child: Card(
...
//                          ),
                          ...
                          Padding(
                            ...
                            child: Column(
                              children: [
                                MyText(title: '${product[index]['name']}',),
                                MyText(title: '${product[index]['brand']}',),
//                                MyText(title: '${product[index]['products'][0]['name']}',),
                              ],
                            ),
                          ),
  ...
  return_listView_shopbyproduct({@required List product}){
    return Container(
